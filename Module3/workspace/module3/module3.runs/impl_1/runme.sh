...
HD_PWD='/thayerfs/home/f003j8y/ENGS62/Module3/workspace/module3/module3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log module3_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source module3_hw_wrapper.tcl -notrace
