...
HD_PWD='/thayerfs/home/f003j8y/ENGS62/Module3/workspace/module3/module3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module3_hw_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module3_hw_wrapper.tcl
