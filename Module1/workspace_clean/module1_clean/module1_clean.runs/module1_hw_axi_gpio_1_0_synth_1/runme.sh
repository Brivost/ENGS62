...
HD_PWD='/thayerfs/home/f003j8y/workspace_clean/module1_clean/module1_clean.runs/module1_hw_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module1_hw_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module1_hw_axi_gpio_1_0.tcl
